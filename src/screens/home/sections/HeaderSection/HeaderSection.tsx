...
export const HeaderSection = (): JSX.Element => {
  ...
  return (
    <Card className="flex flex-col w-full max-w-md gap-2.5 p-5 rounded-[20px] shadow-[0px_4px_4px_#00000040]">
      <CardContent className="p-0 space-y-2.5">
        ...
        <h2 className="font-['Raleway',Helvetica] font-normal text-xl tracking-[0.20px] leading-5">
          {businessData.name}
        </h2>
